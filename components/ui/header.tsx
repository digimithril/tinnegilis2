        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link href="/team" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">
                  <span>Team</span>
                </Link>
              </li>
              <li>
                <Link href="/sponsors" className="font-medium text-gray-600 hover:text-gray-900 px-5 py-3 flex items-center transition duration-150 ease-in-out">
                  <span>Sponsors</span>
                </Link>
              </li>
              <li>
