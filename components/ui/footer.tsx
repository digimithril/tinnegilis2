    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; tinnegilis.com. All rights reserved.</div>
          <div className="text-sm text-gray-600 ml-4">Credit to digimithril.com for creation of website.</div>
        </div>
